...
public class Streams2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "sourav", "krishna", "comment");
        News news2 =new News(2, "sourav", "krishna", "budget");
        News news3 = new News(1, "sourav", "krishna", "comment");
        News news4 = new News(3, "sourav", "krishna", "budget");
        News news5 = new News(1, "sourav", "krishna", "comment");
        News news6 = new News(3, "sourav", "krishna", "budget");
        News news7 = new News(1, "sourav", "krishna" ,"comment");
