...
public  class Assignment2Q3 {
    ...
    public static void main(String[] args) {
        ...
        totalCashInBank.add(acc1.deposit(10000));
        totalCashInBank.add(acc2.deposit(4000));
        totalCashInBank.add(acc3.deposit(100));
        totalCashInBank.add(acc4.deposit(600));
        totalCashInBank.add(acc3.withdraw(5000));
        totalCashInBank.add(acc2.withdraw(300));
